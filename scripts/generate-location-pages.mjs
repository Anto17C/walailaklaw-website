...
function langItem(canonical) {
  return `<div class="lang-item"><a href="#" class="lang-trigger">EN <span class="caret">&#9662;</span></a><div class="lang-dropdown"><a href="/th${canonical}">TH</a><a href="/fr${canonical}">FR</a></div></div>`;
}
